/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 8129f27e1633a59f4410ec1cb3132724)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PUBLIC_ASSET_API_ORIGIN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_URL_PREFIX" | "API_URL_SUFFIX" | "GOOGLE_OAUTH_CLIENT_ID" | "GOOGLE_OAUTH_CLIENT_SECRET" | "PUBLIC_ASSET_API_ORIGIN">> {}
}
