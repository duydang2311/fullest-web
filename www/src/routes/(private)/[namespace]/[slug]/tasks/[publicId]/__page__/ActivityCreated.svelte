<script lang="ts">
    import type { activityValidators } from '~/lib/components/activity-feed/utils.svelte';
    ...
    export const {
        activity,
    }: { activity: InferOutput<(typeof activityValidators)[ActivityKind.Created]> } = $props();
</script>
