        ...
        {:else}
            <div class="border-base-border overflow-auto rounded-lg border">
                ...
                >
                    ...
                    <tbody
                        class="divide-base-border-weak col-span-full grid grid-cols-subgrid divide-y"
                    >
                        {#each data.taskList.items as task (task.id)}
                            ...
                            >
                                <td
                                    class="hover:bg-base-hover active:bg-base-active relative transition"
                                >
                                    <a
                                ...
                                <td
                                    class="hover:bg-base-hover group relative min-w-48 font-medium transition"
                                >
                                    <span>Backlog</span>
                                    <div
                                ...
                                <td
                                    class="hover:bg-base-hover relative min-w-48 font-medium transition"
                                >
                                    <span>Medium</span>
                                    <div
                                        class="border-base-border border-3 absolute bottom-0 right-0 size-0 border-l-transparent border-t-transparent"
