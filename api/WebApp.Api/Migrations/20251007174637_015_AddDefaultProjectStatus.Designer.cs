...
namespace WebApp.Api.Migrations
{
    ...
    [Migration("20251007174637_015_AddDefaultProjectStatus")]
    partial class _015_AddDefaultProjectStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("ProjectStatusHiLoSequence")
                .IncrementsBy(10);
            ...
            modelBuilder.HasSequence("TaskPublicIdHiLoSequence")
                .IncrementsBy(10);
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<long?>("DefaultProjectStatusId")
                        .HasColumnType("bigint")
                        .HasColumnName("default_project_status_id");
                    ...
                    b.HasIndex("DefaultProjectStatusId")
                        .IsUnique()
                        .HasDatabaseName("ix_projects_default_project_status_id");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.ProjectStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    NpgsqlPropertyBuilderExtensions.UseHiLo(b.Property<long>("Id"), "ProjectStatusHiLoSequence");
                    ...
                    b.HasIndex("StatusId")
                        .HasDatabaseName("ix_project_statuses_status_id");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.TaskEntity", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseHiLo(b.Property<long>("PublicId"), "TaskPublicIdHiLoSequence");
                    ...
                    b.HasIndex("ProjectStatusId")
                        .HasDatabaseName("ix_tasks_project_status_id");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Project", b =>
                {
                    b.HasOne("WebApp.Domain.Entities.ProjectStatus", "DefaultProjectStatus")
                        .WithOne()
                        .HasForeignKey("WebApp.Domain.Entities.Project", "DefaultProjectStatusId")
                        .HasConstraintName("fk_projects_project_status_default_project_status_id");
                    ...
                    b.Navigation("DefaultProjectStatus");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.ProjectStatus", b =>
                {
                    ...
                    b.HasOne("WebApp.Domain.Entities.Status", "Status")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_statuses_status_status_id");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.TaskEntity", b =>
                {
                    ...
                    b.HasOne("WebApp.Domain.Entities.ProjectStatus", "ProjectStatus")
                        .WithMany()
                        .HasForeignKey("ProjectStatusId")
                        .HasConstraintName("fk_tasks_project_status_project_status_id");
