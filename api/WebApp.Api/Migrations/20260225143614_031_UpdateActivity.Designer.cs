...
namespace WebApp.Api.Migrations
{
    ...
    [Migration("20260225143614_031_UpdateActivity")]
    partial class _031_UpdateActivity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasIndex("ContextId")
                        .HasDatabaseName("ix_activities_context_id");

                    b.HasIndex("ContextKind")
                        .HasDatabaseName("ix_activities_context_kind");

                    b.HasIndex("ResourceId")
                        .HasDatabaseName("ix_activities_resource_id");

                    b.HasIndex("ResourceKind")
                        .HasDatabaseName("ix_activities_resource_kind");
