...
namespace WebApp.Api.Migrations
{
    ...
    [Migration("20260426191033_038_AddTaskCreatedTimeDefaultValue")]
    partial class _038_AddTaskCreatedTimeDefaultValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "priority_category", new[] { "high", "low", "medium", "urgent" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "status_category", new[] { "active", "archived", "canceled", "completed", "paused", "proposed", "ready", "review" });
            NpgsqlModelBuilderExtensions.UseIdentityByDefaultColumns(modelBuilder);

            modelBuilder.HasSequence("ActivityHiLoSequence")
                .IncrementsBy(10);
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Activity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    NpgsqlPropertyBuilderExtensions.UseHiLo(b.Property<long>("Id"), "ActivityHiLoSequence");
                    ...
                    b.HasIndex("ActorId")
                        .HasDatabaseName("ix_activities_actor_id");

                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_activities_project_id");

                    b.HasIndex("TaskEntityId")
                        .HasDatabaseName("ix_activities_task_entity_id");

                    b.HasIndex("TaskId")
                        .HasDatabaseName("ix_activities_task_id");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Priority", b =>
                {
                    ...
                    b.Property<PriorityCategory>("Category")
                        .HasColumnType("priority_category")
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<string>("DescriptionPreview")
                        .HasColumnType("text")
                        .HasColumnName("description_preview");
            ...
            modelBuilder.Entity("WebApp.Domain.Entities.Activity", b =>
                {
                    b.HasOne("WebApp.Domain.Entities.User", "Actor")
                        .WithMany()
                    ...
                    b.HasOne("WebApp.Domain.Entities.TaskEntity", null)
                        .WithMany("Activities")
                        .HasForeignKey("TaskEntityId")
                        .HasConstraintName("fk_activities_tasks_task_entity_id");

                    b.HasOne("WebApp.Domain.Entities.TaskEntity", "Task")
                        .WithMany()
                        .HasForeignKey("TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_activities_tasks_task_id");
