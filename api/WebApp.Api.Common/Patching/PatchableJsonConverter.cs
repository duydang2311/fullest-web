...
public sealed class PatchableJsonConverter : JsonConverter<Patchable>
{
    ...
    )
    {
        ...
        var properties = typeToConvert
            ...
            .ToDictionary(
                p => options.PropertyNamingPolicy?.ConvertName(p.Name) ?? p.Name,
